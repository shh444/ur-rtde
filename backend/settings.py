...
try:
    from app_config import MODBUS_HOST, MODBUS_POLL_HZ
except ImportError:
    MODBUS_HOST = ROBOT_HOST
    MODBUS_POLL_HZ = 4.0

try:
    from app_config import SHIPYARD_HOST, SHIPYARD_PORT
except ImportError:
    SHIPYARD_HOST = "127.0.0.1"
    SHIPYARD_PORT = 8010

try:
    from app_config import LOG_SOCKET_HOST, LOG_SOCKET_PORT, LOG_SOCKET_BUFFER
except ImportError:
...
DEFAULT_MODBUS_HOST = MODBUS_HOST
DEFAULT_MODBUS_POLL_HZ = float(MODBUS_POLL_HZ)
DEFAULT_SHIPYARD_HOST = SHIPYARD_HOST
DEFAULT_SHIPYARD_PORT = int(SHIPYARD_PORT)
DEFAULT_LOG_SOCKET_HOST = LOG_SOCKET_HOST
DEFAULT_LOG_SOCKET_PORT = int(LOG_SOCKET_PORT)
DEFAULT_LOG_SOCKET_BUFFER = int(LOG_SOCKET_BUFFER)
